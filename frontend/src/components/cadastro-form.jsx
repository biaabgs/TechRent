...
import { EyeIcon, EyeOffIcon, CheckCircle2, Info } from 'lucide-react';
...
const Cadastro = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                setErro(data.error || data.mensagem || data.message || 'Erro ao criar conta.');
                return;
            }
    ...
    const validations = [
        { text: "No mínimo 8 caracteres", valid: form.senha.length >= 8 },
        { text: "Pelo menos 1 letra maiúscula (A-Z)", valid: /[A-Z]/.test(form.senha) },
        { text: "Pelo menos 1 letra minúscula (a-z)", valid: /[a-z]/.test(form.senha) },
        { text: "Pelo menos 1 número (0-9)", valid: /[0-9]/.test(form.senha) },
    ];
            ...
            <Card className="z-1 w-full border-none shadow-md sm:max-w-lg">
                ...
                <CardContent>
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        {/* Senha */}
                        <div className="space-y-1">
                            <Label htmlFor="senha-realtime">Senha</Label>
